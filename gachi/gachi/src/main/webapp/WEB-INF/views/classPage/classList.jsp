...
<div class="container cfont">
	...
	<span>
		<a href="/gachi/classList"  style="font-weight: bold;">전체</a> &nbsp; <a href="#">공예/창작</a> &nbsp; 
		<a href="/gachi/classList?category=요리">요리</a> &nbsp; <a href="/gachi/classList?category=미술">미술</a> &nbsp; 
		<a href="/gachi/classList?category=음악">음악</a> &nbsp; <a href="/gachi/classList?category=라이프스타일">라이프스타일</a> &nbsp; 
		<a href="/gachi/classList?category=운동">운동</a> &nbsp; <a href="/gachi/classList?category=사진/영상">사진/영상</a> &nbsp; 
	</span>
	...
	<div class="row">
		<c:forEach var="list" items="${list }">
			<div class="col-sm-4">
				<a href="/gachi/classView"><img src="/gachi/img/${list.class_img1 }" class="homeClassListImg"/></a><br/>
				<div class="homeClassListTxt">
					<p><span>${list.category }</span><i class="far fa-heart fa-lg p-2" style="float:right; height: 15px;"></i></p>
					<a href="/gachi/classView"><span>${list.class_name }</span><br/>
