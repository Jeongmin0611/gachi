...
<ul class="text_center ad_box" id="ad_video_addList">
	...
	<c:forEach var="vo" items="${videoList}">
		<ul class="videoList">
			...
			<li class="wordCut"><a href="/gachi/adminVideoView?code=${code}&video_filename=${vo.video_filename}">
...
<ul>
	<li class="content_center">
		...
		<button type="button" class="btn" onclick="location.href='/gachi/adminVideo'">목록보기</button>
	</li>
</ul>
</form>
</div>